      ...
      <section className="md:flex md:justify-between md:items-start">
        ...
        <div className="md:w-1/2 mb-8 md:mb-0">
          <h1 className="text-2xl md:text-4xl font-bold leading-tight mb-4">
            Travel Services in Nanital
          </h1>
          <h3 className="mt-5 text-xl md:text-2xl font-bold leading-tight mb-4">
            Check Nanital to Delhi Taxi Service Fare
          </h3>
          <p className="text-gray-700 leading-relaxed">
            Welcome to the dedicated page for Taxi Service in Nanital brought
            to you by CabiFY. We take pride in providing top-notch taxi
            services tailored to your needs, ensuring a comfortable and
            reliable journey. Our services in Nanital include outstation
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            Nanital to Delhi and Delhi to Nanital routes. Your safety and
        ...
        <div className="space-y-8">
          <div>
            <h6 className="text-lg md:text-xl font-bold leading-tight mb-2">
              Delhi to Nanital Taxi:
            </h6>
            <p className="text-gray-700 leading-relaxed">
              Planning a trip to the capital? Book your Delhi to Nanital taxi
              with Mr. Cabie for a stress-free and comfortable journey.
              Nanital to Delhi taxi fare stays between Rs.2900 to Rs.4500
          ...
          <div>
            <h6 className="text-lg md:text-xl font-bold leading-tight mb-2">
              Nanital to Delhi Taxi Fare:
            </h6>
            <p className="text-gray-700 leading-relaxed">
              Need a reliable ride back to Nanital from Delhi? Count on Mr.
