...
function Bhimtal() {
  return (
    ...
    <header
      ...
      style={{
        backgroundImage:
          "url(https://images.pexels.com/photos/27970045/pexels-photo-27970045/free-photo-of-Bhimtal.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1)",
      }}
    >
      ...
      <section className="md:flex md:justify-between md:items-start">
        ...
        <div className="md:w-1/2 mb-8 md:mb-0">
          <h1 className="text-2xl md:text-4xl font-bold leading-tight mb-4">
            Travel Services in Bhimtal
          </h1>
          <h3 className="mt-5 text-xl md:text-2xl font-bold leading-tight mb-4">
            Check Bhimtal to Delhi Taxi Service Fare
          </h3>
          <p className="text-gray-700 leading-relaxed">
            Welcome to the dedicated page for Taxi Service in Bhimtal brought
            to you by CabiFY. We take pride in providing top-notch taxi
            services tailored to your needs, ensuring a comfortable and
            reliable journey. Our services in Bhimtal include outstation
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            Bhimtal to Delhi and Delhi to Bhimtal routes. Your safety and
        ...
        <div className="space-y-8">
          <div>
            <h6 className="text-lg md:text-xl font-bold leading-tight mb-2">
              Delhi to Bhimtal Taxi:
            </h6>
            <p className="text-gray-700 leading-relaxed">
              Planning a trip to the capital? Book your Delhi to Bhimtal taxi
              with Mr. Cabie for a stress-free and comfortable journey.
              Bhimtal to Delhi taxi fare stays between Rs.2900 to Rs.4500
          ...
          <div>
            <h6 className="text-lg md:text-xl font-bold leading-tight mb-2">
              Bhimtal to Delhi Taxi Fare:
            </h6>
            <p className="text-gray-700 leading-relaxed">
              Need a reliable ride back to Bhimtal from Delhi? Count on Mr.
